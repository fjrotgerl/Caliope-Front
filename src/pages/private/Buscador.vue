            ...
            <div v-for="usuario in usuariosEncontrados" class="q-pa-md float-left" style="width: 300px;">
              <q-card class="my-card">
                <q-item>
                  ...
                  <q-item-section>
                    <q-item-label @click="$router.push('/user/perfil/' + usuario.username)">{{usuario.username}}</q-item-label>
                    <q-item-label @click="$router.push('/user/perfil/' + usuario.username)" caption>{{usuario.nombre + " " + usuario.apellidos}}</q-item-label>
                  </q-item-section>
                </q-item>

                <img @click="$router.push('/user/perfil/' + usuario.username)" src="https://cdn.quasar.dev/img/parallax2.jpg">
              </q-card>
            </div>
